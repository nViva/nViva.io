...
<header>
  ...
  <div class="subnav">
    ...
    <div class="subnav-content">
      ...
      <li>
  <div class="subnav">
    <button class="subnavbtn" class="active">Settings <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
...
<div>
            ...
            <div class="main-content-inner">
                ...
                <th colspan="6" >
               Your Profile updated successfully! Your New Username and Password are: <font color="red"><?php echo " ". $_SESSION['newusername']. " ". $_SESSION['newpassword']; ?></font> respectively. 
                </th></tr>
                 </tbody>
                                        </table>
