...
<div>
      ...
      <?php 
               ...
               $sql = "SELECT * FROM Products WHERE productName LIKE '%$mysearch%'";
                 ...
                 while ($row = $result->fetch_assoc()) 
         {
            ...
            <th><center> <a href="up"Edit></a><a href="edit.php?id=<?php echo $row["productId"] ?>">Edit</a> <a href="up"Edit></a><a href="delete.php?id=<?php echo $row["productId"] ?>">Delete</a></center></th>
            ...
            <?php
               ...
               <a href="stock_print.php" >Print</a>
                </th></tr>
                <tr><th>
               <!-- <button id="PrintButton" onclick="printy()">Print</button> -->
