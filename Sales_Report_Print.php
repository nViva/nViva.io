...
<body  onload="window.print()">
            ...
            <div class="main-content-inner">
              ...
              <h4 class="header-title">NPC PRODUCTION REPORT</h4>
               <h4 class="header-title">SALES REPORT OF <?php echo $a;?> To <?php echo $b;?> AS ON <?php echo"".date("y-m-d");?></h4><hr>
                                        ...
                                        <table class="table text-dark text-center">
                                             <thead class="text-uppercase">
                                               <tr class="table-active">
                                                    ...
                                                    <th scope="col">Sales Total Price</th>
            ...
            <?php 
               ...
               $sql = "SELECT Products.productId,Sales.productId,Products.productName,Sales.quantity,Sales.selling_price,Sales.salesDate FROM Products JOIN Sales ON Products.productId=Sales.productId WHERE Sales.salesDate BETWEEN '".$a."' AND '".$b."'";
